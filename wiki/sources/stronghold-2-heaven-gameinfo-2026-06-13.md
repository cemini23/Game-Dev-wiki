---
title: Stronghold 2 Heaven — gameinfo community reference (2026-06-13)
type: source
tags: [source, stronghold-2, community, wiki]
...
- **Site:** Stronghold 2 Heaven — HeavenGames community wiki
- **URL:** https://stronghold2.heavengames.com/gameinfo/
- **Author credit:** Merepatra and contributors (honour, kingmaker, popularity pages ingested 2026-06-13)

## Narrative

Primary **mechanics reference** for SH2 personal-clone research. Indexed sections:

| Section | URL path | Ingested into |
|---------|----------|---------------|
| Honour | `/gameinfo/honour/` | @concepts/stronghold-2-systems-inventory.md § honour |
...
- [x] Popularity numeric tables → @concepts/stronghold-2-popularity-model.md
...
Community formula preserved on honour page — feast honour = `(4 × guests × food_types) + 10`.
