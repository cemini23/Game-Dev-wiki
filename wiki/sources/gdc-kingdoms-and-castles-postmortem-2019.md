---
title: GDC 2019 — Kingdoms and Castles postmortem
type: source
tags: [source, gdc, kingdoms-and-castles, indie, postmortem]
keywords: [gdc, kingdoms-and-castles, city-builder, lion-shield, scope]
related:
...
- @concepts/indie-kingdom-builder-lessons.md — distilled takeaways
- @entities/games/stronghold-series.md — adjacent genre reference

## Raw Concept

2019 GDC postmortem on indie kingdom-builder **Kingdoms and Castles** (Lion Shield / Peter Angstadt).
...
> "Verified viability by testing audience interest before release." — Game Developer summary of GDC 2019 talk
